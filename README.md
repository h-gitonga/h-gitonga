...
Technical Focus: Python, SQL, Apache Airflow, Docker, PySpark, Pandas, NumPy, scikit-learn, PyTorch, data visualization libraries (Matplotlib & Seaborn), and healthcare data systems.
